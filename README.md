...
<p>I have constructed a website with an attractive, simple form that has a design and colour-scheme to reflect the band's sound. The site allows visitors to listen to the band's music, watch videos and catch up on the latest news. Whilst the website will be regularly updated, the band has additional content on various social media platforms. The site therefore contains prominent links to these external sites.
...
<p>The ability to contact the band is a key concern and so there is a second link to the contact page in the footer of the site.</p> 

<p>In terms of the appearance of the site, The Weavers are a heavy rock and roll outfit and so I decided that a dark colour scheme is best suited to their sound. It also provides a nice contrast to the splashes to colour in the photographs and landing page.</p> 
  
<p>Below are three user stories. Each scenario is explored in more detail in the testing section of this document.</p> 

<ol>
  <li>Alistair and Mandy are engaged to be married. Their wedding is in six months’ time. They are fans of rock and roll and want an experienced outfit with a large back-catalogue who can also take requests in advance of the big day and during the reception itself. They visit the site and immediately see that there is a page featuring testimonials from couples for whom the band has performed in the past. They are impressed by the feedback and so hit the button in the footer of the site (“Get a Free Quote”) and complete the form with details of their event.</li> 
...
<p>Images of the original design of the site are below. I decided during the constuction of the site to use a black background throughout and to simply have a single page ("Listen") where vistors could both watch videos and listen to tracks.</P>
...
<ol>
  <li>Feature 1 – In the header are links to six pages (Home, Listen, Photographs, News, Testimonials, Contact the Weavers). On smaller screen sizes, the navbar shrinks to a burger icon and drops down to reveal the navbar.</li>
...
<li>Feature 3 – The “Listen” page allows users to listen to six of the band’s tracks an view one of the band’s music videos.</li> 

<li>Feature 4 – “Photographs” – This page shows a number of images of the band on stage as well as some shots of happy, dancing wedding guests.</li> 

<li>Feature 5 – “News” – This page details the latest goings on with The Weavers. Any recently published stories are indicted with a "NEW" icon. This section also includes any upcoming shows with a link to an external ticketing site (which does not function as this is a front-end only site).</li> 
...
<p>The code was tests on validator.w3.org with errors identified and corrected. One exception is the width of the site's images. Validator identified these as errors and stated that I should remove the % sign from the width attribute. Despite experimenting with other techniques, I found that stating the % in the element was the best way to achieve the result I was looking for. No errors were identified with the CSS file.</p>
...
<p>The navigation bar displays the links to all pages on desktop view. This collapses to a burger on smaller screens (mobile phone and tablet).</p> 
...
<li>The photos used in this site were obtained from https://pxhere.com/en/tag/549.</li> 
  <li>I used https://www.font-generator.com/ to create the bands logo.</li>
</ul>
